    ...
    try {
        ...
        client.execute({
            ...
            statement.on('end',()=> {
                ...
                sourceData = buildFile(jsonValid, filename, outFileFormat);
...
function buildFile(jsonValid, filename, outFileFormat) {
    //Create file <filename>.outFileFormat with content jsonValid
    let sourceData = filename+"."+outFileFormat;
    fs.writeFileSync(sourceData, jsonValid);
    //return "examples\\4. PointOfInterestSource.json";
    return sourceData;
}
